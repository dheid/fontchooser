...
public class DefaultFontSelectionModelTest {
	...
	public void containsSelectedFont() {
        ...
        assertThat(actualFont).isEqualTo(font);
	}
	...
	public void addsChangeListener() {
        ...
        assertThat(changeListeners).contains(changeListener);
	}
	...
	public void removesChangeListener() {
		...
		ChangeListener[] changeListeners = defaultFontSelectionModel.getChangeListeners();
        assertThat(changeListeners).isEmpty();
	}
	...
	public void informsAboutChangedStates() {
        ...
        assertThat(defaultFontSelectionModel.getSelectedFont()).isEqualTo(otherFont);
        ...
        assertThat(changeEvent.getSource()).isEqualTo(defaultFontSelectionModel);
	}
